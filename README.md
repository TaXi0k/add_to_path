...
> [!CAUTION]
> **Add to path** supports only **[BASH](https://www.gnu.org/software/bash/)** and **[ZSH](https://zsh.sourceforge.io/)** shells. And likely won't ever support any other, since these are only two popular ones.
...
To me, I did this. I don't know why I even wrote this xd.
